 ...
 * @author JRS
 */
public class MenuItem extends javax.swing.JDialog {
     ...
     */
    public MenuItem(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                MenuItem dialog = new MenuItem(new javax.swing.JFrame(), true);
